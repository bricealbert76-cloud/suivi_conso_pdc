...
class PdcMajWindow(tk.Toplevel):
    ...
    def _compute_nucleus_exclusions(self):
        ...
        Exclus : intervenants dont TOUS les projets PDC (cache JH) appartiennent
                 uniquement à SURV_COMM_PROJECTS OU uniquement à ANALYTIC_PROJECTS.
        """
        exclusions = set()
        for u_norm, prj_dict in self._cache_jh.items():
            # Projets avec au moins une valeur JH > 0
